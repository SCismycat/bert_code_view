...
def create_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, use_tpu):
    ...
    # 线性衰减初始化，如果global_step < num_warmup_steps, 学习率将是如果global_step/num_warmup_steps * init_lr
    if num_warmup_steps:
        ...
        optimizer = AdamWeightDecayOptimizer(
            learning_rate=learning_rate,weight_decay_rate=0.01,beta_1=0.9,beta_2=0.999,
...
class AdamWeightDecayOptimizer(tf.train.Optimizer):
    ...
    def apply_gradients(self, grads_and_vars, global_step=None, name=None):
        ...
        for (grad, param) in grads_and_vars:
            ...
            next_v = (tf.multiply(self.beta_2,v) + tf.multiply(1.0 - self.beta_2),
                      tf.square(grad))
